            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="padding-right: 150px">
              ...
              <li class="nav-item dropdown" style="padding-right: 30px">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="/showpengaduan">Data Pengaduan</a></li>
                  <li><a class="dropdown-item" href="/showtanggapan">Data Tanggapan</a></li>
                </ul>
              </li>
              <li class="nav-item" style="padding-right: 30px">
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="/showtanggapan">Data Tanggapan</a>
                                </li>
                            </ul>
                        </li>
                                ...
                                <div class="card" style="width: 250px">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <a href="/kelas"><h4 class="text-muted font-semibold pt-2">Data Tanggapan</h4></a>    
                                            </div>
                                        </div>
                                    </div>
                                </div>
